...
"C:/Users/Esther/Documents/GitHub/MICS_SMDW") #substitute path with where you have this repository locally saved
...
# 1= Improved but not explicitely on plot
...
vector[which(vector_orig ==  "DISALINATION PLANT WATER")] = 1
vector[which(vector_orig == "WATER KIOSK")] = 1
vector[which(vector_orig == "WATER KIOSK (WATER SELLING PLANT)")] = 1
vector[which(vector_orig == "DISALINATION PLANT WATER")] = 1
vector[which(vector_orig == "Quiosque de agua")] = 1
vector[which(vector_orig == "WATER KIOSK CONNECTED WITH PIPED WATER")] = 1
vector[which(vector_orig == "WATER KIOSK NOT CONNECTED WITH PIPED WATER")] = 1
vector[which(vector_orig == "Quiosque de Agua")] = 1
vector[which(vector_orig == "KIOSQUE A EAU")] = 1
vector[which(vector_orig == "Quiosque de agua")] = 1

# 2= Piped to dwelling, compound or yard
