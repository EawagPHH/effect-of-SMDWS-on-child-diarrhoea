...
extractStandardSurveyVariables <- function(hh_Survey){
  hh_Survey <- hh_Survey %>% 
    select("HH1","HH2","WQ27", "WS7", "WS3","HH7","HH6","WS1","HH48","WS4","wqsweight","WS2","hhweight", "WS8", "country","HH5D","HH5M","HH5Y") 
  return(hh_Survey)
  }
...
extractVariablesFromBangladesh <- function(hh_Bangladesh){
  ...
  hh_Bangladesh_SMDW <- hh_Bangladesh %>% 
    select("HH1","HH2","WQ27", "WS7", "WS3","HH7","HH6","WS1","HH48","WS4","wqeweight","WS2","hhweight", "WS8", "country","HH5D","HH5M","HH5Y") 
...
extractVariablesFromCongo <- function(hh_Congo){
  hh_Congo_SMDW <- hh_Congo %>%  
    select("HH1","HH2","WQ27", "WS3","HH7","HH6","WS1","WS4","WS2","hhweight","WS8","HH11", "country","HH5D","HH5M","HH5Y")
  hh_Congo_SMDW$WS7 <- 0
...
extractVariablesFromCote_dIvoire <- function(hh_Cote_dIvoire){
  hh_Cote_dIvoire_SMDW <- hh_Cote_dIvoire %>% 
    select("HH1","HH2", "WQ31", "WS3","HH7","HH11","HH6","WS1","WS4","wqweight","WS2","hhweight", "country","HH5D","HH5M","HH5Y")
...
extractVariablesFromLesotho <- function(hh_Lesotho){
  hh_Lesotho_SMDW <- hh_Lesotho %>% 
    select("HH1","HH2", "WQ27", "WS7", "WS3","HH6","WS1","HH48","WS4","HH7A","wqsweight","WS2","hhweight","WS8", "country","HH5D","HH5M","HH5Y") 
...
extractVariablesFromNigeria <- function(hh_Nigeria){
  hh_Nigeria_SMDW <- hh_Nigeria %>% 
    select("HH1","HH2","WQ23", "WS5A", "WS3","HH7","HH6","WS1","HH11","WS4A","wqsweight","WS2","hhweight", "country", "HH5D","HH5M","HH5Y") 
...
extractVariablesFromParaguay <- function(hh_Paraguay){
  hh_Paraguay_SMDW <- hh_Paraguay %>% 
    select("HH1","HH2","WQ23", "WS5C", "WS3","HH7","HH6","WS1","HH11","WS4","paweight","WS2","hhweight", "country","HH5D","HH5M","HH5Y")
...
hh_Tuvalu_SMDW <- hh_Tuvalu %>% 
  select("HH1","HH2","WQ27", "WS7", "WS3","HH7","HH6","WS1","HH48","WS4","wqsweight","WS2","hhweight", "country","HH5D","HH5M","HH5Y",) 
